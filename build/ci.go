...
import (
	...
	"github.com/aiyaya188/klaytn/crypto/signify"
	"github.com/aiyaya188/klaytn/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/aiyaya188/klaytn/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/aiyaya188/klaytn/mobile")
