...
import (
	...
	ethereum "github.com/aiyaya188/klaytn"
...
func (ec *Client) FilterLogs(ctx context.Context, q ethereum.FilterQuery) ([]types.Log, error) {
	...
	err = ec.c.CallContext(ctx, &result, "klay_getLogs", arg)
	return result, err
}
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg ethereum.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
	err := ec.c.CallContext(ctx, &hex, "klay_call", toCallArg(msg), rpc.BlockNumberOrHashWithHash(blockHash, false))
	if err != nil {
		return nil, err
	}
	return hex, nil
...
func (ec *Client) SuggestGasTipCap(ctx context.Context) (*big.Int, error) {
	var hex hexutil.Big
	if err := ec.c.CallContext(ctx, &hex, "klay_maxPriorityFeePerGas"); err != nil {
		return nil, err
	}
	return (*big.Int)(&hex), nil
}
...
func (ec *Client) SendTransaction(ctx context.Context, tx *types.Transaction) error {
	...
	return ec.c.CallContext(ctx, nil, "klay_sendRawTransaction", hexutil.Encode(data))
}
